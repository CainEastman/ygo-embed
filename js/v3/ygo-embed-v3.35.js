...
/* Deck List Styles */
.ygo-deck-section {
    margin: 4px 0 16px 0 !important; /* Reduced top margin, increased bottom margin */
    padding: 0 !important;
    width: 100% !important;
...
.ygo-deck-section {
    margin: 4px 0 16px 0 !important; /* Consistent with above */
    padding: 0 !important;
    width: 100% !important;
    box-sizing: border-box !important;
}
...
.ygo-cards {
    margin: 0 0 12px 0 !important; /* Added bottom margin to grid container */
    padding: 0 !important;
    width: 100% !important;
...
/* Add spacing after the last deck section */
.ygo-deck-section:last-child {
    margin-bottom: 24px !important; /* Extra spacing after the final section */
}
`;
