...
.dib-post-content .ygo-card-entry img,
div[class*="dib"] .ygo-card-entry img {
    width: 100% !important;
...
/* Reset any DropInBlog paragraph styles that might affect our elements */
.dib-post-content p.ygo-card-entry,
.dib-post-content div.ygo-card-entry,
div[class*="dib"] p.ygo-card-entry,
div[class*="dib"] div.ygo-card-entry {
    margin: 0 !important;
    padding: 0 !important;
    line-height: normal !important;
}

/* Mobile Responsive Styles with stronger selectors */
@media (max-width: 768px) {
    .dib-post-content .ygo-cards,
    div[class*="dib"] .ygo-cards {
...
/* Container overrides to remove side spacing */
.dib-post-content .ygo-deck-section,
