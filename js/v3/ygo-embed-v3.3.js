(() => {
  ...
  async function renderDeckSection(section, names, deckType, titleMap, fetchCards2) {
    ...
    for (let entry of names) {
      ...
      cardQuantities[cardName.toLowerCase()] = qty;
    }
    try {
      ...
      for (let cardName of cardsToFetch) {
        ...
        const noPunctName = normalizedName.replace(/[.,\/#!$%\^&\*;:{}=\-_`~()]/g, "");
        const card = cardsByName[normalizedName] || cardsByName[noPunctName] || Object.values(cardsByName).find(
...
//# sourceMappingURL=ygo-embed-v3.3.js.map
