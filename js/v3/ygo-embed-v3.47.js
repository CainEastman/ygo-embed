...
.dib-post-content div + .ygo-deck-section,
.dib-post-content .ygo-deck-section + div {
...
/* Force override any DropInBlog container margins */
.dib-post-content > div > .ygo-deck-section:first-child {
    margin-top: 2px !important;
}
...
@media (max-width: 480px) {
    ...
    .dib-post-content div.ygo-deck-section .ygo-cards {
        ...
        gap: 8px 2px !important; /* Maintain same spacing on mobile */
    }
}
...
.dib-post-content .ygo-deck-section .ygo-card-entry {
    ...
    gap: 1px !important;
    min-height: calc(3.9em + 16px) !important;
}
...
/* Additional cursor styles for image and name links */
.dib-post-content .ygo-deck-section .ygo-card-entry a {
    cursor: inherit !important;
}

.dib-post-content .ygo-deck-section .ygo-card-entry a:hover {
