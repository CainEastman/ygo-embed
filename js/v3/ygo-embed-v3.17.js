...
.ygo-card-entry {
    flex: 0 0 calc(16.666% - 17px); /* 6 cards across with gap compensation */
...
@media (max-width: 1400px) {
    .ygo-card-entry {
        flex: 0 0 calc(20% - 16px); /* 5 cards across */
...
@media (max-width: 900px) {
    .ygo-card-entry {
        flex: 0 0 calc(33.333% - 14px); /* 3 cards across */
...
@media (max-width: 600px) {
    .ygo-card-entry {
        flex: 0 0 calc(50% - 10px); /* 2 cards across */
...
@media (max-width: 768px) {
    .ygo-card-entry {
        flex: 0 1 calc(50% - 8px); /* 2 cards across on mobile */
        min-width: 120px;
    }
