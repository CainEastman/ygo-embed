...
/* Deck List Styles */
.ygo-deck-section {
    margin: 0 !important; /* Reset margin to handle spacing through parent */
    padding: 0 !important;
    width: 100% !important;
...
.ygo-deck-section + .ygo-deck-section {
    margin-top: 8px !important; /* Space between consecutive sections */
}

/* Container overrides for the entire decklist area */
.dib-post-content .ygo-deck-section,
.dib-post-content div.ygo-deck-section,
div[class*="dib-"] .ygo-deck-section,
#dib-posts .ygo-deck-section {
    margin: 0 -16px !important; /* Remove top/bottom margin, keep negative side margins */
    padding: 0 !important;
...
/* Add proper spacing to the overall decklist container */
.dib-post-content div:has(> .ygo-deck-section),
div[class*="dib-"]:has(> .ygo-deck-section),
#dib-posts div:has(> .ygo-deck-section) {
    margin: 16px 0 !important; /* Equal spacing above and below entire decklist */
    padding: 0 !important;
}
...
.ygo-card-entry .ygo-card-name:hover {
    color: #ffd700;
}
...
/* Override DropInBlog Spacing */
.dib-post-content .ygo-deck-section,
div[class*="dib"] .ygo-deck-section {
    margin: 4px -16px !important; /* Reduced top margin from 8px to 4px */
    padding: 0 !important;
    width: calc(100% + 32px) !important;
    max-width: none !important;
    box-sizing: border-box !important;
...
/* Add margin to the bottom of deck sections */
.dib-post-content .ygo-deck-section:not(:last-child),
.dib-post-content div.ygo-deck-section:not(:last-child),
div[class*="dib-"] .ygo-deck-section:not(:last-child),
#dib-posts .ygo-deck-section:not(:last-child) {
    margin-bottom: 8px !important;
}

/* Adjust section title spacing */
.dib-post-content .ygo-deck-section > h3,
div[class*="dib"] .ygo-deck-section > h3 {
    margin: 0 0 4px 0 !important;
    padding: 0 16px 4px 16px !important; /* Add horizontal padding to align with content */
    border-bottom: 2px solid rgba(255, 255, 255, 0.1) !important;
    line-height: 1.2 !important;
}

/* Grid layout with forced compact sizing */
.dib-post-content .ygo-deck-section .ygo-cards,
div[class*="dib-"] .ygo-deck-section .ygo-cards,
#dib-posts .ygo-deck-section .ygo-cards,
body .dib-post-content .ygo-cards {
    display: grid !important;
    grid-template-columns: repeat(6, minmax(0, 1fr)) !important; /* Force equal columns with no minimum */
    gap: 1px !important;
    margin: 0 !important;
    padding: 0 !important;
    width: 100% !important;
...
/* Force card entries to be compact */
.dib-post-content .ygo-deck-section .ygo-cards .ygo-card-entry,
div[class*="dib-"] .ygo-deck-section .ygo-cards .ygo-card-entry,
#dib-posts .ygo-deck-section .ygo-cards .ygo-card-entry,
body .dib-post-content .ygo-card-entry {
    width: 100% !important;
    min-width: 0 !important; /* Prevent minimum width */
...
/* Handle card names */
.dib-post-content .ygo-card-entry .ygo-card-name,
div[class*="dib-"] .ygo-card-entry .ygo-card-name,
#dib-posts .ygo-card-entry .ygo-card-name,
body .dib-post-content .ygo-card-entry .ygo-card-name {
...
/* Force images to be compact */
.dib-post-content .ygo-deck-section .ygo-cards .ygo-card-entry img,
div[class*="dib-"] .ygo-deck-section .ygo-cards .ygo-card-entry img,
#dib-posts .ygo-deck-section .ygo-cards .ygo-card-entry img,
body .dib-post-content .ygo-card-entry img {
    width: 100% !important;
    min-width: 0 !important;
    max-width: 100% !important;
...
@media (max-width: 480px) {
    ...
    body .dib-post-content .ygo-cards {
        ...
        padding: 0 8px !important; /* Smaller padding on mobile */
    }
...
/* Override DropInBlog content spacing */
...
/* Target the specific deck section containers */
.dib-post-content > div:has(.ygo-deck-section),
div[class*="dib-"] > div:has(.ygo-deck-section),
#dib-posts > div:has(.ygo-deck-section) {
...
/* Override any DropInBlog paragraph margins that might affect our sections */
.dib-post-content p,
.dib-post-content div,
div[class*="dib-"] p,
div[class*="dib-"] div,
...
.dib-post-content div:has(.ygo-deck-section),
div[class*="dib-"] p:has(.ygo-deck-section),
div[class*="dib-"] div:has(.ygo-deck-section),
#dib-posts p:has(.ygo-deck-section),
#dib-posts div:has(.ygo-deck-section) {
    margin: 8px 0 !important;
    padding: 0 !important;
}

/* Ensure consistent spacing for the grid container */
.ygo-cards {
    margin: 0 !important;
    padding: 0 !important;
    width: 100% !important;
