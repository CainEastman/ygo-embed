...
#dib-posts .ygo-deck-section {
    margin: 8px -16px !important; /* Negative margin to counteract container padding */
    padding: 0 !important;
    width: calc(100% + 32px) !important; /* Compensate for negative margins */
...
@media (max-width: 480px) {
    ...
    div[class*="dib-"] .ygo-deck-section,
    #dib-posts .ygo-deck-section {
        margin: 8px -8px !important; /* Smaller negative margin on mobile */
